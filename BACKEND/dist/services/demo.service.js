...
exports.seedDemoWorkspacesForUser = void 0;
...
const seedDemoWorkspacesForUser = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        for (const d of dummyData) {
            let u = yield user_model_1.default.findOne({ email: d.email });
            if (!u) {
        ...
        const ws1 = yield workspace_model_1.default.create({
        ...
        const proj1 = yield project_model_1.default.create({
        ...
        const proj2 = yield project_model_1.default.create({
        ...
        const ws2 = yield workspace_model_1.default.create({
        ...
        const proj3 = yield project_model_1.default.create({
...
exports.seedDemoWorkspacesForUser = seedDemoWorkspacesForUser;
